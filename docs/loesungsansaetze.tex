...
\bild{1}{rl.png}{Diagramm der Interaktion des Agenten mit der Umgebung \zitat{S.48}{SB20}}{fig:rl}
...
\\
Um die Optimalen Funktionen v und q zu finden müssen beide die Bellman-Gleichung erfüllen \zitat{S.73}{SB20}:
\begin{equation}
...
Dieser Ansatz des Mone-Carlo-Search-Tree MCST entspricht grundlegend der Umsetzung dieses Papers \zitat{}{AlphaGO}, angepasst auf unser Problem.
\\\\
